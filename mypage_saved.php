            ...
            <div class="flex_item">
                ...
                <?php
                    ...
                    if(isset($_POST['private'])):
                        ...
                        $private = 0;
                        $private_check = $private_check = '<input type="checkbox" name="private" value="TRUE">';
                    endif;
                    $temp_art_disp = "";
                    ...
                    $sql = "SELECT * FROM TEMP_ARTICLE WHERE id=:id";
                ...
                <div class="main">
                    ...
                    <div align="right">
                        ...
                        <input type="submit" name="del_article" value="下書きを削除" style="padding: 8px 40px; font-size: 1.2em;">
